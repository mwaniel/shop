      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="col-md-10 mx-auto col-lg-5">
          <table class="table text-start align-middle table-bordered table-hover mb-0">
            <tbody>
              <tr class="text-dark">
                <td scope="col">Name: <b>{{$result['product']['name']}}</b></td>
              </tr>
                <td scope="col">Quantity: <b>{{$result['product']['quantity']}}</b></td>
              </tr>
              <tr class="text-dark">
                <td scope="col">Price: <b>{{$result['product']['price']}}</b></td>
              </tr>
              <tr class="text-dark">
                <td scope="col">Discount: <b>{{$result['product']['discount']}}</b></td>
              </tr>
              <tr class="text-dark">
                <td scope="col">VAT: <b>{{$result['product']['vat']}}</b></td>
              </tr>
              <tr class="text-dark">
                <td scope="col">Status: 
                  <b>
