...
<div class="container fashion_section">
  ...
  <div class="invoice p-3 mb-3">
      ...
      <div class="col-12">
        ...
        <h1><b>INVOICE</b></h1>
         <div class="card callout callout-info">
          ...
          Payment Method is set to Mobile money. An STK push will be forwarded to your safaricom number. Enter your pin and wait for confirmation.
        </div>
      </div>
      <!-- /.col -->
    </div>
    ...
    <div class="row">
      ...
      <div class="col-6">
        <p class="lead">Payment Method: M - Pesa</p>
    ...
    <div class="row no-print">
      <div class="col-12">
        <form id="m-pesa-transaction-form" action="{{route('m-pesa-transaction')}}" method="POST">
          @csrf
          <div>
            ...
            <input type="hidden" name="type" value="m-pesa">
          </div>
